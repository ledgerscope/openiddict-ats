...
namespace OpenIddict.Ats
{
        ...
        where TToken : OpenIddictAtsToken, new()
    {
        ...
        public virtual async ValueTask CreateAsync(TToken token, CancellationToken cancellationToken)
        {
            ...
            insertOperation.Entity.RowKey = Guid.NewGuid().ToString(); //TODO: Deterministic
        ...
        public virtual async ValueTask DeleteAsync(TToken token, CancellationToken cancellationToken)
        {
            ...
            var idFilter = TableQuery.GenerateFilterCondition(nameof(OpenIddictAtsToken.PartitionKey), QueryComparisons.Equal, token.PartitionKey);
            ...
            string client, CancellationToken cancellationToken)
        {
            ...
            async IAsyncEnumerable<TToken> ExecuteAsync([EnumeratorCancellation] CancellationToken cancellationToken)
            {
                ...
                var query = new TableQuery<TToken>().Where(filter);
            ...
            string status, CancellationToken cancellationToken)
        {
            ...
            async IAsyncEnumerable<TToken> ExecuteAsync([EnumeratorCancellation] CancellationToken cancellationToken)
            {
                ...
                var query = new TableQuery<TToken>().Where(filters);
        ...
        public virtual IAsyncEnumerable<TToken> FindByApplicationIdAsync(string identifier, CancellationToken cancellationToken)
        {
            ...
            async IAsyncEnumerable<TToken> ExecuteAsync([EnumeratorCancellation] CancellationToken cancellationToken)
            {
                ...
                var condition = TableQuery.GenerateFilterCondition(nameof(OpenIddictAtsToken.ApplicationId), QueryComparisons.Equal, identifier);
        ...
        public virtual IAsyncEnumerable<TToken> FindByAuthorizationIdAsync(string identifier, CancellationToken cancellationToken)
        {
            ...
            async IAsyncEnumerable<TToken> ExecuteAsync([EnumeratorCancellation] CancellationToken cancellationToken)
            {
                ...
                var condition = TableQuery.GenerateFilterCondition(nameof(OpenIddictAtsToken.AuthorizationId), QueryComparisons.Equal, identifier);
        ...
        public virtual async ValueTask<TToken?> FindByIdAsync(string identifier, CancellationToken cancellationToken)
        {
            ...
            do
            {
                ...
                var token = queryResult.Results.FirstOrDefault();
        ...
        public virtual IAsyncEnumerable<TToken> FindBySubjectAsync(string subject, CancellationToken cancellationToken)
        {
            ...
            async IAsyncEnumerable<TToken> ExecuteAsync([EnumeratorCancellation] CancellationToken cancellationToken)
            {
                ...
                var condition = TableQuery.GenerateFilterCondition(nameof(OpenIddictAtsToken.Subject), QueryComparisons.Equal, subject);
        ...
        public virtual ValueTask<string?> GetIdAsync(TToken token, CancellationToken cancellationToken)
        {
            ...
            return new ValueTask<string?>(token.PartitionKey?.ToString());
        }
        ...
        public virtual async ValueTask PruneAsync(DateTimeOffset threshold, CancellationToken cancellationToken)
        {
            ...
            var tokenQueryResultTask = ctToken.ExecuteQueryAllAsync(tokenQuery, cancellationToken).ToListAsync(cancellationToken);

            var authQuery = new TableQuery<OpenIddictAtsAuthorization>();
            var authQueryResult = await ctAuth.ExecuteQueryAllAsync(authQuery, cancellationToken).ToListAsync(cancellationToken);

            var tokenQueryResult = await tokenQueryResultTask;
